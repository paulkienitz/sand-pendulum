...
To use the Windows exe, adjust the two numeric sliders (or edit the numbers directly), then just click on the surface.
...
In its day it was a better alternative to MFC for Windows apps.
